"""
I have ammended line 657 to enable imitation learning exploration. other_agent_batches
and which policies to train a model of teacher can be accessed

This is a modified version of ray/rllib/evaluation/simple_list_collector.py
"""
import collections
    ...
    def postprocess_episode(
        ...
        for agent_id, (_, pre_batch) in pre_batches.items():
            ...
            if getattr(policy, "exploration", None) is not None:
                # Code ammended by me: to access other_agent_batches and
                # which exploration nets need to be trained with policy_mapping_fn
                if policy.config['exploration_config']['type'] == 'Imitation':
                    policy.exploration.postprocess_trajectory(
                        policy, post_batches[agent_id], other_batches, agent_id, episode,
