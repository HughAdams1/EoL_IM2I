...
"""
line 584 I've added in strict=False, this allows me to upload a checkpoint without imitation,
to a network that has imitation.
"""
...
class TorchPolicy(Policy):
    ...
    def set_weights(self, weights: ModelWeights) -> None:
        ...
        self.model.load_state_dict(weights, strict=False) #my_addition
